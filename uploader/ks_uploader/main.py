...
class KSVideo(object):
    def __init__(self, title, file_path, tags, publish_date: datetime, account_file,enableTimer=False):
    ...
    async def upload(self, playwright: Playwright) -> None:
        ...
        await page.get_by_text("作品描述").locator("xpath=following-sibling::div").click()
        ...
        max_retries = 60*3  # 设置最大重试次数,最大等待时间为 2 分钟
        retry_count = 0
    ...
    async def set_schedule_time(self, page, publish_date):
        ...
        await page.keyboard.press("Meta+A")
        await page.keyboard.type(str(publish_date_hour), delay=100)
        await asyncio.sleep(1)
##microSupport > div > div > div > div > div > div.ant-picker-footer > ul > li > button
        await page.keyboard.press("Enter")
        await asyncio.sleep(1)
